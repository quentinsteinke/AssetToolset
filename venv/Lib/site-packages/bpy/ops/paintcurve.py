...
def add_point(override_context: typing.Union[dict, 'bpy.types.Context'] = None,
...
def cursor(override_context: typing.Union[dict, 'bpy.types.Context'] = None,
           execution_context: typing.Union[str, int] = None,
           undo: bool = None):
    ''' Place cursor
...
def slide(override_context: typing.Union[dict, 'bpy.types.Context'] = None,
          execution_context: typing.Union[str, int] = None,
          undo: bool = None,
          *,
          align: bool = False,
