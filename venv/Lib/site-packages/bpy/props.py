...
def BoolVectorProperty(
        ...
        update=None,
        get=None,
        set=None) -> typing.Union[list, 'bpy.types.BoolProperty']:
    ...
    :param get: Function to be called when this value is 'read', This function must take 1 value (self) and return the value of the property.
    :param set: Function to be called when this value is 'written', This function must take 2 values (self, value) and return None.
    :rtype: typing.Union[list, 'bpy.types.BoolProperty']
    '''
...
def FloatVectorProperty(
        ...
        update=None,
        get=None,
        set=None) -> typing.Union[list, 'bpy.types.FloatProperty']:
    ...
    :param get: Function to be called when this value is 'read', This function must take 1 value (self) and return the value of the property.
    :param set: Function to be called when this value is 'written', This function must take 2 values (self, value) and return None.
    :rtype: typing.Union[list, 'bpy.types.FloatProperty']
    '''
...
def IntVectorProperty(name: str = "",
                      ...
                      update=None,
                      get=None,
                      set=None) -> typing.Union[list, 'bpy.types.IntProperty']:
    ...
    :param get: Function to be called when this value is 'read', This function must take 1 value (self) and return the value of the property.
    :param set: Function to be called when this value is 'written', This function must take 2 values (self, value) and return None.
    :rtype: typing.Union[list, 'bpy.types.IntProperty']
    '''
